                    ...
                    <form action="{{ route('entry.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row ml-2 mb-4 pb-1">
                                <div class="col-md">
                                    ...
                                    <button type="button" tabindex="-1" class="btn btn-primary btn-sm mb-2 btn-tambah-organisasi_nu">
                            ...
                            <div class="row ml-2 mb-4 pb-1">
                                <div class="col-md">
                                    ...
                                    <button type="button" tabindex="-1" class="btn btn-primary btn-sm mb-2 btn-tambah-organisasi_lain">
                                        <i class="fas fa-plus"></i>
                                        Tambah data
                                    </button>
                                    <table class="table table-striped table-sm">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header pb-0">
                    <h4 class="mb-0">Aktifitas NU Lainnya</h4>
